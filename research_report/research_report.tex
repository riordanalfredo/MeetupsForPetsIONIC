...
architectural changes to arrange files in the correct directories. ADM (Architecture-Driven Modernization) method 
\cite{b2} could potentially be the candidate to solve this issue. 
