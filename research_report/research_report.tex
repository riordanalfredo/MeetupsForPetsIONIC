...
\bibitem{b7} R. Gronback, "Eclipse Modeling Project | The Eclipse Foundation", Eclipse.org, 2019. [Online]. Available: https://www.eclipse.org/modeling/emf/. [Accessed: 04- Nov- 2019].
\bibitem{b8} "Sirius - Overview", Eclipse.org, 2019. [Online]. Available: https://www.eclipse.org/sirius/overview.html. [Accessed: 04- Nov- 2019].
\bibitem{b9} "Acceleo | Home", Eclipse.org, 2019. [Online]. Available: https://www.eclipse.org/acceleo/. [Accessed: 04- Nov- 2019].
