...
Also, \cite{b6} provides specific methods to conduct reverse-engineering 
that is involved our process.

In \cite{b3} and \cite{b5} studies are proving the feasibility of model-driven engineering
in other contexts from our studies. Those contexts are migration to another completely new framework, 
migration to a new architecture (legacy achitecture to service-oriented architecture), and migration
of mobile applications. They also provided insights of how model-driven engineering processes in software migration
to be economically profitable and provides cost-effectiveness. 

The \cite{b4} study is related to our work in terms of processing different kind of 
programming languages and paradigms to produce a functional mobile application. In
our case, the extension type of generated codes are still maintained. This study also
gives insight how the model-driven development feasible in producing fully functional 
...
https://pdfs.semanticscholar.org/8968/7958518252817c4bbe02c77fcef5a48a8d3c.pdf
